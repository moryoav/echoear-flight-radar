...
MAP_METADATA_FILENAME = "flight_radar_map_metadata.h"
...
def map_metadata_source(lat: float, lon: float) -> str:
    """Return the C++ metadata compiled alongside the generated map images."""
    return f"""#pragma once

// Generated by tools/generate_map.py. Do not edit manually.
namespace echoear_flight_radar_map {{
static constexpr float CENTER_LATITUDE = {lat:.7f}f;
static constexpr float CENTER_LONGITUDE = {lon:.7f}f;
}}  // namespace echoear_flight_radar_map
"""


def write_map_metadata(lat: float, lon: float, output: Path) -> None:
    output.parent.mkdir(parents=True, exist_ok=True)
    output.write_text(map_metadata_source(lat, lon), encoding="utf-8", newline="\n")
...
def main() -> None:
    ...
    if args.all_ranges:
        ...
        write_map_metadata(
            args.lat,
            args.lon,
            args.output_dir / MAP_METADATA_FILENAME,
        )
        return
